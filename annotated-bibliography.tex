...
\begin{itemize}
  ...
  \item \textcite{iyengar2025futureaidf}: Surveys future AI-driven DF themes including redundancy reduction, recovery, tool security, and speculative quantum synergy.
  ...
  \item \textcite{karie2014dfdisciplinesontology}: Proposes a five-layer ontology of digital forensic disciplines for curriculum, certification, and tool scoping.
  ...
  \item \textcite{smirnov2024ontologyneurosymbolic}: Evaluates ontology-aware neuro-symbolic networks for prediction quality and explanation understandability.
